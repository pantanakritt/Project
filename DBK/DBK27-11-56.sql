...
-- 
-- Host: localhost
-- Generation Time: Nov 27, 2013 at 02:12 PM
...
INSERT INTO `dblog_table` VALUES (32, '131120112148', 'admin', 'Import CSV file to server name tempCSV2013_11_20_11_24_47.csv<br>', '127.0.0.1', '2013-11-20 11:24:47');
INSERT INTO `dblog_table` VALUES (33, '131122025006', 'admin', 'Import CSV file to server name tempCSV2013_11_22_14_53_20.csv<br>Import CSV file to server name tempCSV2013_11_22_14_54_31.csv<br>Import CSV file to server name tempCSV2013_11_22_14_56_28.csv<br>Import CSV file to server name tempCSV2013_11_22_15_11_13.csv<br>', '127.0.0.1', '2013-11-22 15:11:13');
INSERT INTO `dblog_table` VALUES (34, '131122061923', 'admin', 'Import CSV file to server name tempCSV_2013_11_22_19_14_02.csv<br>Import CSV file to server name tempCSV_2013_11_22_19_28_22.csv<br>Import CSV file to server name tempCSV_2013_11_22_19_30_43.csv<br>Import CSV file to server name tempCSV_2013_11_22_19_31_43.csv<br>Import CSV file to server name tempCSV_2013_11_22_19_36_29.csv<br>Import CSV file to server name tempCSV_2013_11_22_19_49_56.csv<br>Import CSV file to server name tempCSV_2013_11_22_19_50_08.csv<br>', '127.0.0.1', '2013-11-22 19:50:08');
...
INSERT INTO `permission_table` VALUES (1, 'admin', '1234', 'tempCSV_2013_11_22_19_50_08.csv', 'ธนกฤต', 'อองกุลนะ', 0, 0, 0, 0, 1, 'l3eethoven@me.com', '0869319312', 1, '27 11 13 01 06 127.0.0.1');
...
-- 
-- Table structure for table `temp_schedule_table`
-- 

CREATE TABLE `temp_schedule_table` (
  ...
  `time_start` tinyint(2) NOT NULL,
  `time_end` tinyint(2) NOT NULL,
  `room` varchar(5) NOT NULL,
...
-- 
-- Dumping data for table `temp_schedule_table`
-- 
